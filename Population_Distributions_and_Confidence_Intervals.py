...
def sample_procedure(dist):
    ...
    # The line below if answer to Optional Challenge Part 1. 
    ...
    for e in confidence_intervals:   
        ...
        # The confidence interval (s,t) is the interval we need for Optional Challenge Part 3(a)
        u = min(lower_bounds)      # The minimum of lower bounds 
        v = max(upper_bounds)      # The maximum of upper bounds 
        
        # The confidence interval (u,v) is the interval we need for Optional Challenge Part 3(b)
    ...
    if c>s and c<t:    # Checking for answer of Optional Challenge Part 3(a)
    ...
    if c>u and c<v:   # Checking for answer of Optional Challenge Part 3(b)
